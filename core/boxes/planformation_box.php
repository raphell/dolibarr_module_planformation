 ...
 */
class planformationbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "planformation@planformation";
    public $boxlabel;
    public $depends = array("planformation");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/planformation/class/planformation.class.php";
